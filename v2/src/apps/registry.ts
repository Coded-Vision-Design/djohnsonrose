...
export const apps: Record<string, AppDef> = {
  edge: { id: 'edge', title: 'Chrome', icon: `${IMG}chrome.webp`, defaultSize: { w: 1024, h: 720 }, Component: Placeholder },
  ...
  outlook: { id: 'outlook', title: 'Outlook', icon: `${IMG}outlook.webp`, defaultSize: { w: 720, h: 600 }, Component: Placeholder },
