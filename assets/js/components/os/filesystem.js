...
window.osFileSystem = {
    'C:\\': [
        { name: 'Users', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Program Files', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Program Files (x86)', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Windows', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files': [
        { name: 'Adobe', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Docker', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Google', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Microsoft Office', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Microsoft VS Code', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'XAMPP', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files\\Adobe': [
        { name: 'photoshop.exe', type: 'app', app: 'photoshop', icon: window.portfolioConfig.imgPath + 'photoshop.webp' },
        { name: 'Adobe Premiere Pro 2024', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Adobe Illustrator 2024', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Adobe After Effects 2024', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files\\Google': [
        { name: 'Chrome', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files\\Google\\Chrome': [
        { name: 'Application', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    ...
    'C:\\Program Files\\Microsoft VS Code': [
        ...
        { name: 'bin', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'resources', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files\\Microsoft Office': [
        { name: 'root', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files\\Microsoft Office\\root': [
        { name: 'Office16', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    ...
    'C:\\Program Files\\XAMPP': [
        { name: 'htdocs', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'mysql', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'php', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'xampp-control.exe', type: 'file', icon: '🧡' }
    ],
    'C:\\Program Files (x86)': [
        { name: 'FileZilla FTP Client', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Image-Line', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Notepad++', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'PuTTY', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files (x86)\\Image-Line': [
        { name: 'FL Studio 24', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Program Files (x86)\\Notepad++': [
        { name: 'notepad++.exe', type: 'file', icon: window.portfolioConfig.imgPath + 'notepad++.webp' },
        { name: 'plugins', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    ...
    'C:\\Program Files (x86)\\FileZilla FTP Client': [
        ...
        { name: 'docs', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Windows': [
        { name: 'System32', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'SysWOW64', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Fonts', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Web', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Media', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Resources', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Windows\\System32': [
        { name: 'drivers', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'config', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
    ...
    'C:\\Windows\\Web': [
        { name: 'Wallpaper', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Screen', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Windows\\Media': [
    ...
    'C:\\Windows\\Resources': [
        { name: 'Themes', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    ...
    'C:\\Users': [
        { name: 'DeVante', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Public', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Users\\DeVante': [
        { name: 'Desktop', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/desktop.webp' },
        { name: 'Documents', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/documents.webp' },
        { name: 'Downloads', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/downloads.webp' },
        { name: 'Pictures', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/pictures.webp' },
        { name: 'Projects', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Users\\DeVante\\Desktop': [
        { name: 'Projects', type: 'folder', path: 'C:\\Users\\DeVante\\Projects', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
...
- British Judo Squad: https://www.britishjudo.org.uk/wp-content/uploads/2024/10/British-Masters-Squad-2024-2025.pdf` },
        ...
        // 'link' branch below.
        { name: 'React Build', type: 'link', url: '/v2/', icon: window.portfolioConfig.imgPath + 'react.webp' },
    ...
    'C:\\Users\\DeVante\\Documents': [
        { name: 'Career', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
    ...
    'C:\\Users\\DeVante\\Projects': [
        { name: 'Freelance', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Killik and Co', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Coded Vision Design', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'UEA', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Skyscanner', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Shawbrook Bank', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'FRP Advisory', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    'C:\\Users\\DeVante\\Projects\\Freelance': [
        { name: 'English Open BJJ', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, OpenAI', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Bay Motors', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'CPT Tours', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, MySQL', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'EKBJJ', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, OpenAI', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'BJJ Havering', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, OpenAI', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'BHR Recovery', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, WhatsApp', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Youngs Construction', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Euro-Goat', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX, Three.js', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Hameedahs Delights', type: 'folder', status: '✅', techStack: 'PHP, Tailwind, Alpine, HTMX', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' },
        { name: 'Boulevard Logistics', type: 'folder', status: '✅', techStack: 'Custom Software, PHP, Logistics, FinTech', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
    ...
    'C:\\Users\\DeVante\\Projects\\Freelance\\English Open BJJ': [
        ...
        { name: 'Pictures', type: 'folder', icon: window.portfolioConfig.imgPath + 'win11/folder.webp' }
    ],
