document.addEventListener('alpine:init', () => {
    Alpine.data('calcApp', () => ({
        ...
        buttons: [
            ...
            { label: '7', val: '7', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '8', val: '8', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '9', val: '9', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '×', val: '*', class: 'bg-gray-100 dark:bg-white/5 text-xl' },
            { label: '4', val: '4', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '5', val: '5', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '6', val: '6', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '-', val: '-', class: 'bg-gray-100 dark:bg-white/5 text-xl' },
            { label: '1', val: '1', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '2', val: '2', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '3', val: '3', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '+', val: '+', class: 'bg-gray-100 dark:bg-white/5 text-xl' },
            { label: '<sup>+</sup>/<sub>-</sub>', val: 'pm', class: 'bg-white dark:bg-white/10 font-bold shadow-xs' },
            { label: '0', val: '0', class: 'bg-white dark:bg-white/10 text-lg font-bold shadow-xs' },
            { label: '.', val: '.', class: 'bg-white dark:bg-white/10 font-bold shadow-xs' },
            { label: '=', val: '=', class: 'bg-win-blue text-white text-xl hover:bg-blue-600! shadow-xs' },
        ],
